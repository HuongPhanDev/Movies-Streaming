...
export default function Movie() {
  const [allMovies, setAllMovies] = useState<MovieData>({ results: [] });
  ...
  return (
    <div className='ourMovieContainer'>
      <BannerTwo children={<h1>Our Movie</h1>}/>
      <div className='ourMovieContent'>
      <FilterPanel/>
      <MovieList movies={allMovies} bigTitle='All movies' smallTitle='ONLINE STREAMING'/>
      </div>
      <Footer />
    </div>
  )
